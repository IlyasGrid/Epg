            ...
            <div class="conditions-forms">
                ...
                <div class="mb-6 form-group">
                    ...
                    <input type="text" class="border border-gray-200 rounded p-2 w-full form-control" name="type"
                        placeholder="individuel, en group" value="{{ old('type') }}" />
                ...
                <div class="mb-6 form-group">
                    ...
                    <input type="text" maxlength="10" class="border border-gray-200 rounded p-2 w-full form-control"
                        name="volume_horraire" placeholder="2h  par semaine, 1h30 par semaine ...   "
